...
| :--- | :--- | :--- | :--- |
| **Geographic Seller Concentration** | Level 1: Structural Root Cause | **Level 1: Structural Baseline Layer** | 70.9% of sellers in SP is an exogenous geographic reality. Distance does not directly cause dissatisfaction; it creates long-haul exposure mediated by duration. |
| **Carrier Linehaul Transit Delay** | Level 2: Operational Root Cause | **Level 2: Primary Operational Driver** | Carrier transit represents 76.9% of fulfillment duration ($9.3\text{d}$ avg) and exhibits an adjusted standardized OR of $2.20$ ($+120.0\%$ excess odds/SD vs $+38.0\%$ for seller handling). Observational association, not counterfactual proof. |
| **Seller Warehouse Handling Delay** | Level 2: Operational Root Cause | **Level 2: Secondary Operational Bottleneck** | Accounts for 23.1% of duration ($2.8\text{d}$ avg) and adjusted standardized OR of $1.38$ ($+38.0\%$ excess odds/SD). A significant bottleneck in the $9.4\%$ tail of slow merchants ($>5\text{d}$ dispatch). |
